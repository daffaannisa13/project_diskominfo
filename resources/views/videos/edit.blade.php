            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <small class="text-muted float-end">Form untuk mengedit video</small>
                    </div>
                    <div class="card-body">
                        <!-- Success message -->
                        @if(session('success'))
                        ...
                        <!-- Form to edit an existing video -->
                        <form action="{{ route('video.update', $video->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukkan judul video" value="{{ old('judul', $video->judul) }}" required />
                                    @error('judul')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="url" class="form-control" id="url" name="url" required placeholder="Masukkan URL video" value="{{ old('url', $video->url) }}" />
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" id="kategori_id" name="kategori_id" required>
                                        ...
                                        @foreach($kategoris as $kategori)
                                            <option value="{{ $kategori->id }}" {{ old('kategori_id', $video->kategori_id) == $kategori->id ? 'selected' : '' }}>{{ $kategori->nama_kategori }}</option>
                                        @endforeach
                                    </select>
                                    @error('kategori_id')
                                        <small class="text-danger">{{ $message }}</small>
